...
const content = `# Pages CMS Database Architecture
...
`;
fs.writeFileSync(path.join(process.cwd(), 'docs', 'PAGES-CMS-DATABASE-ARCHITECTURE.md'), content);
console.log('Created docs/PAGES-CMS-DATABASE-ARCHITECTURE.md');
