...
const content = `# Pages CMS Content Mapping
...
fs.writeFileSync(path.join(process.cwd(), 'docs', 'PAGES-CMS-CONTENT-MAPPING.md'), content);
console.log('Created docs/PAGES-CMS-CONTENT-MAPPING.md');
