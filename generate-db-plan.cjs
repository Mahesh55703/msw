...
const content = `# Pages CMS Migration Plan
...
`;
fs.writeFileSync(path.join(process.cwd(), 'docs', 'PAGES-CMS-MIGRATION-PLAN.md'), content);
console.log('Created docs/PAGES-CMS-MIGRATION-PLAN.md');
